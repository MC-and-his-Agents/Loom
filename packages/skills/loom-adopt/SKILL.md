...
- Loom 根级定位文档
  ...
  - `README.md`
- 初始化相关稳定规则
  - [references/shared/adoption/lightweight-retrofit-default.md](references/shared/adoption/lightweight-retrofit-default.md)
  - [references/shared/adoption/routing-and-checkpoints.md](references/shared/adoption/routing-and-checkpoints.md)
  - [references/shared/harness/fact-chain-contract.md](references/shared/harness/fact-chain-contract.md)
  - [references/loom-init/input-signals.md](references/loom-init/input-signals.md)
  - [references/loom-init/output-contract.md](references/loom-init/output-contract.md)
- 本 skill 的场景合同
