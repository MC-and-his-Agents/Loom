...
当前 Loom package 从 canonical `plugins/loom/.codex-plugin/` manifest 和 `plugins/loom/skills/` 发布 Codex 用户级 plugin payload。已提交的根 `skills/` tree 是源码镜像，不是 single-skill 分发表面。
