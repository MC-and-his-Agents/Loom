...
权威规则见 [governance/principles.md](./governance/principles.md)。

## 5. 规格准入

边界事项默认必须先说明再实现，最小工件为 `spec.md` 与 `plan.md`。

规格准入触发条件与准入问题定义见 [governance/principles.md](./governance/principles.md)。
...
每个 checkpoint 的审查职责分工与回退规则见 [governance/review-model.md](./governance/review-model.md)。
...
角色边界、最小上下文与基线规则见 [governance/review-model.md](./governance/review-model.md)。
...
权威规则见 [governance/maturity-and-closing.md](./governance/maturity-and-closing.md)。
