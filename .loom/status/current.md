...
- Execution Path: issue #875 -> branch work/875-pr-metadata-drift-legacy-fixtures -> workspace `/Users/mc/dev/Loom-worktrees/875-pr-metadata-drift-legacy-fixtures` -> PR pending.
...
- Closing Condition: PR merged to main, issue #875 closed completed, Project Loom Done, and closeout evidence records PR, head SHA, merge commit, target branch, validation, and Project truth.
