...
- Verification Entry: Targeted unittest suite, npm smoke, npm package check, release surface check, version surface check, and full CLI contract passed before PR creation.
- Lane Entry: main-controller-pr-prep
