...
- Current Stop: Host governance capability implementation and v0.23.0 release metadata have been prepared on branch `work/1805-host-governance-capability` at head `5496c4b1eaa379d4391930e214d7a9719bf7a99e`; PR creation, current-head review, hosted gates, merge, publish, readback, and closeout remain.
