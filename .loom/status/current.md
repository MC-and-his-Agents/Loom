...
- Current Stop: Bootstrap carrier repair, spec review, and implementation review refresh are authored locally; PR metadata still needs the new head before gate/hosted checks can pass.
