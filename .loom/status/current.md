...
- Current Stop: PR #1571 is open at head 2b0dc891ec6f16e47cac6517d7780f163b994f8c for the reopened closeout runtime `--item` contract slice: repo-local closeout parser, retained-item lookup, bootstrap manifest hash, and focused governance-closeout regressions are updated; PR metadata readback is fresh.
