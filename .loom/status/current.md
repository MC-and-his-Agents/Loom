...
- Verification Entry: `python3 tools/py_compile_clean.py tools/loom.py tools/check_cli_contract.py`, `rg -n "gh pr view" tools/loom.py`, `python3 tools/check_cli_contract.py --surface release-readback`, suite validate, suite carrier validate, and release closeout-sync dogfood dry-run passed.
