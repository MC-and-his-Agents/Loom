...
- Current Stop: Implementation PR #1839 is bound to current reviewed head 3ccfba249669cf89e85bdc96616369fc4e476020 with runtime-upgrade implementation, checkpoint normalization, review carrier, bootstrap hash, and shadow carrier refresh pushed. Awaiting hosted checks and controlled merge before #1838 release convergence.
- Next Step: Wait for or rerun hosted checks for PR #1839 after the latest PR body readback, merge PR #1839 when gates pass, then run #1838 v0.24.0 release/readback/closeout from main.
