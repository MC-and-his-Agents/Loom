...
- Current Stop: Scheduler prepared WI-1383 current-head review baseline on PR #1416 after fixing validation evidence drift; PR metadata preflight is bound to the live PR head through the machine carrier and parser readback.
