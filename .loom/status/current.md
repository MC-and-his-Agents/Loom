...
- Recovery Boundary: Reviewed head `bab4092b457509b6a8f0437649e36023078567de` includes the closeout backlink fix, WI-987 spec suite, WI-987 spec review carrier, and WI-835 terminal carrier refresh; subsequent changes are governance evidence refresh only.
