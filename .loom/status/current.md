...
- Current Stop: Implementation, focused wrapper validation, aggregate CLI contract, suite gates, fact-chain, state-check, evidence validation, carrier validation, build evidence, spec review, implementation review, PR creation, PR metadata, and merge checkpoint carrier readiness are integrated for `loom ship --apply`.
