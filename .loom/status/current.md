...
- Verification Entry: git diff --check; fact-chain pass; suite validate not_applicable with valid rationale; root-self-governance equivalent checks pass; checkpoint build/merge pass; carrier refresh dry-run current. Pending PR metadata/readback, PR gate, hosted checks, release/no-release evidence, controlled merge, and closeout.
