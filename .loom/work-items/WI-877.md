...
- Execution Path: issue #877 -> branch work/877-pr-metadata-parser-preflight -> workspace `.` in the checked out issue-scoped worktree recorded on issue #877 -> PR #1192
- Workspace Entry: .
...
- Closing Condition: PR #1192 merged to main, issue #877 closed completed, Project Loom Done, and closeout evidence records PR, head SHA, merge commit, target branch, validation, and Project truth.
