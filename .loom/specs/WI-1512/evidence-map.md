...
| EV-004 | pr_metadata_evidence | `.loom/runtime/pr/WI-1512-pr-body.md` | PR #1572 machine carrier | Work Item, branch, head SHA, and surface binding | present | PR gate / merge-ready | Regenerate PR body and readback after each commit. |
