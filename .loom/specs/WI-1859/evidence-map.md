...
| EV-004 | behavior_evidence | README.md | S4 / A4 A5 | WI-1859 / current PR head | present | review / merge-ready / closeout | Rerun skills generate/check and aggregate after route text changes in README, README.zh-CN, CLI matrix, or route matrices. |
| EV-005 | test_evidence | .loom/progress/WI-1859.md | A5 | WI-1859 / current PR head | present | review / merge-ready / closeout | Refresh validation summary after final test run, including runtime-upgrade, aggregate, suite, fact-chain, and plugin hash checks. |
