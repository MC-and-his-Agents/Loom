...
6. Validate targeted cache hygiene, skills surface, host adapter, version surface, loom_check, installer version gate, and Git diff cleanliness.
7. Push PR, wait for checks, merge, then close out #857 and Project #4.
