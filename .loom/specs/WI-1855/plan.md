...
- Produces:
  ...
  - Fresh verification evidence expectation: `.loom/progress/WI-1855.md` latest validation summary and release readiness document.
- Locator:
  - Plan locator: `.loom/specs/WI-1855/plan.md`
- Provenance:
  - Source spec / issue / PR / doc locator: `.loom/specs/WI-1855/spec.md`, #1855.
...
Deliver the `v0.25.0` release candidate and prepare it for release workflow publication after merge.
...
- Locator: #1855 / main-push `loom-cli-release` workflow.
...
- Locator: #1850, #1851-#1855, milestone #22.
- Reason: closure requires post-merge release readback.
- Activation condition: `loom release readback --version v0.25.0` returns published and carrier closeout-sync completes.
...
- Deliverable: version bump, plugin payload metadata/hash, release readiness doc, WI-1855 carriers.
...
- Deliverable: `v0.25.0` tag, GitHub Release, npm package, workflow readback, terminal carrier closeout, issue/milestone closure.
...
- Do not close #1851 or milestone #22 before release readback passes.
...
- Manual checks:
  - GitHub PR, release workflow, issue, and milestone readbacks.
- Runtime evidence:
  - post-merge `loom release readback --target . --version v0.25.0 --release-judgment release_required --json`
- Behavior evidence:
...
- Execution ledger validation evidence locator:
  - `.loom/specs/WI-1855/evidence-map.md`; `docs/evidence/v0.25.0-release-readiness.md`
...
- Blocking inputs:
  - #1851 implementation PR #1856 merged to `main`.
