...
- Installer version metadata advances because generated runtime distribution surfaces changed.

## Compatibility

- Existing `loom_check.py --profile auto|source|consumer` behavior remains unchanged.
- The change is documentation, contract validation, generated surface synchronization, and installer version metadata only; it must not introduce runtime locks or change fixture generation behavior.
