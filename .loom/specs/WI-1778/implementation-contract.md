# WI-1778 Implementation Contract

## Ownership

- Owns root release authority: `VERSION` and root `package.json`.
- Owns v0.21.0 plugin payload release metadata in `plugins/loom/.codex-plugin/plugin.json`.
- Owns v0.21.0 release readiness evidence and WI-1778 carriers.
...
- Do not add newly discovered product improvements to the v0.21.0 release PR unless they directly block #1778 release/closeout consistency.
- Do not close #1774 or milestone #18 until #1778 release readback proves v0.21.0 publication and no stale child issue remains.
...
- If v0.21.0 is not published, revert the release PR before merge or bump to a new unoccupied version before retrying.
