...
| EV-003 | fresh_verification_input | .loom/progress/WI-874.md | EV-001 EV-002 plus git diff --check, skills_surface check, loom_check, CLI contract, release/version/package surface checks, and suite validation | WI-874 / latest validation summary / PR pending | present | merge-ready / closeout / status | Refresh progress summary after final validation, PR creation, or head changes. |
