...
| review record | .loom/reviews/WI-1534.json | pending | authored review truth | Required after review consumption. |
...
| EV-004 | fresh_verification_input | .loom/progress/WI-1534.md | EV-001; EV-002; EV-003 | branch work/1534-closeout-mode-docs validation at current PR head | present | review, PR gate, hosted checks, milestone closeout | Refresh after review, PR metadata readback, hosted checks, or further docs changes. |
