...
| `implementation-contract.md` | .loom/specs/WI-1534/implementation-contract.md | required | authored Work Item carrier | Recheck when docs/skills protocol contract changes. |
...
| EV-003 | test_evidence | tools/check_cli_contract.py | .loom/specs/WI-1534/spec.md S4; .loom/specs/WI-1534/implementation-contract.md | targeted protocol/fixture assertions for closeout mode vocabulary | present | local and hosted checks | Extend if mode vocabulary or field names change. |
