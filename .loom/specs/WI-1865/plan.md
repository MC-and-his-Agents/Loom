...
- Produces:
  ...
  - Fresh verification evidence expectation: `.loom/progress/WI-1865.md` latest validation summary and release readiness document.
- Locator:
  - Plan locator: `.loom/specs/WI-1865/plan.md`
- Provenance:
  - Source spec / issue / PR / doc locator: `.loom/specs/WI-1865/spec.md`, #1865.
...
Deliver the `v0.26.0` release candidate and prepare it for release workflow publication after merge.
...
- Locator: #1865 / main-push `loom-cli-release` workflow.
...
- Locator: #1859-#1865, milestone #23.
- Reason: closure requires post-merge release readback.
- Activation condition: `loom release readback --version v0.26.0` returns published and carrier closeout-sync completes.
...
- Deliverable: version bump, plugin payload metadata/hash, release readiness doc, WI-1865 carriers.
...
- Deliverable: `v0.26.0` tag, GitHub Release, npm package, workflow readback, terminal carrier closeout, issue/milestone closure.
...
- Do not close #1859 or milestone #23 before release readback passes.
...
- Runtime evidence:
  - post-merge `loom release readback --target . --version v0.26.0 --release-judgment release_required --json`
- Behavior evidence:
...
- Execution ledger validation evidence locator:
  - `.loom/specs/WI-1865/evidence-map.md`; `docs/evidence/v0.26.0-release-readiness.md`
...
- Blocking inputs:
  - #1859 implementation PR #1866 merged to `main`.
