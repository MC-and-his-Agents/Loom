...
| EV-004 | implementation_contract | `.loom/specs/WI-1484/implementation-contract.md` | S1-S3 and A1-A5 in `.loom/specs/WI-1484/spec.md` | work_item=WI-1484; suite_path=minimal | present | PR gate; merge-ready; #1486; #1488; #1489 | Recheck after output contract, non-goal boundary, or validation command changes. |
