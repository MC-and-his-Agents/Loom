# WI-1129 Implementation Contract
...
- `docs/methodology/harness/full-spec-suite-cli-surface.md`
- WI-1129 `.loom/` carrier files
- `.loom/progress/WI-1127.md` terminal recovery update for the already-merged previous Work Item

## Non-Goals

- Do not implement suite carrier inspect/validate.
- Do not wire evidence scaffold or validation into merge-ready or closeout gates.
- Do not write review, merge-ready, closeout, host, Project, `/speckit.*`, or `.specify/` truth from CLI evidence scaffold commands.
- Do not mark generated scaffold rows as `present`.
- Do not rewrite frozen #1014-#1020 core contracts.

## Verification

- `git diff --check`
- Focused `rg` for `suite evidence scaffold`, `missing`, `/speckit`, and `.specify`
