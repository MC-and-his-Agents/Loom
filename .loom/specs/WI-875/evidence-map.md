...
| EV-003 | fresh_verification_input | .loom/progress/WI-875.md | EV-001 EV-002 plus git diff, focused rg, skills surface, loom_check, and CLI contract checks | WI-875 / latest validation summary / PR pending | present | merge-ready / closeout / status | Refresh progress summary after PR creation, head changes, or additional validation. |
