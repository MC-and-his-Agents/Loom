...
- Produces:
  ...
  - Fresh verification evidence expectation: `.loom/progress/WI-1884.md` latest validation summary and release readiness document.
- Locator:
  - Plan locator: `.loom/specs/WI-1884/plan.md`
- Provenance:
  - Source spec / issue / PR / doc locator: `.loom/specs/WI-1884/spec.md`, #1884.
...
Deliver the `v0.26.3` release candidate and prepare it for release workflow publication after merge.

Explicitly deferred until after merge: GitHub tag, GitHub Release, npm publish, release readback, issue closure, and terminal carrier closeout.

## Deferred Items

### Post-Merge Release Publication

- Locator: #1884 / main-push `loom-cli-release` workflow.
...
- Locator: #1881/#1882/#1884.
- Reason: closure requires post-merge release readback and terminal carrier closeout.
- Activation condition: `loom release readback --version v0.26.3` returns published and carrier closeout-sync completes.
...
- Deliverable: version bump, plugin payload metadata/hash, release readiness doc, WI-1884 carriers.
...
- Deliverable: `v0.26.3` tag, GitHub Release, npm package, workflow readback, terminal carrier closeout, issue closure.
- Exit condition: all release evidence and GitHub issue readbacks agree.
...
- Do not close #1881, #1882, or #1884 before release readback passes.
...
- Runtime evidence:
  - post-merge `loom release readback --target . --version v0.26.3 --release-judgment release_required --json`
- Behavior evidence:
...
- Execution ledger validation evidence locator:
  - `.loom/specs/WI-1884/evidence-map.md`; `docs/evidence/v0.26.3-release-readiness.md`
...
- Acceptance test mapping:
  ...
  - A5 -> test evidence: closeout-sync and GitHub issue readback.

## Dependencies

- Blocking inputs:
  - #1883 implementation PR #1885 merged to `main`.
