...
8. Refresh the root bootstrap hash carriers after repo-local `.loom/bin/loom_check.py` changes.
9. Record minimal WI-1675 Loom carriers for fact-chain, workspace, PR, hosted freeze, and closeout consumption.
