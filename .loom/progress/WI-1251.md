...
- Current Stop: PR #1413 branch is rebased onto origin/main dba1f55690150336211c767069c9189df90c000a and now includes a review-run fixture env helper fix for the hosted NameError while preserving #1251 Codex App fallback fixture isolation and WI-1251 not_applicable suite metadata. Local focused validation, review-run source surface, state-check, and #1252 terminal carrier readback pass; scheduler-owned current-head review/shadow refresh is next.
