...
- Validation Evidence Locator: `.loom/progress/WI-1025.md`; `.loom/reviews/WI-1025.spec.json`; `.loom/reviews/WI-1025.json`; PR pending; #1025 completion comment pending
