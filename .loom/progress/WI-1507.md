...
- Recovery Boundary: WI-1507/#1507 contract only. Do not implement the follow-on CLI, PR body hash pin, carrier/shadow runtime behavior, review/head implementation, hosted admission workflow, classifier implementation, fixtures/skills update, release/no-release closeout, or unrelated runtime changes.
