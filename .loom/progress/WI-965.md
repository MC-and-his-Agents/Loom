...
- Current Stop: WI-965 PR recovery fixes are validated locally after CI drift: demo bootstrap comparison now canonicalizes host-dynamic GitHub control-plane evidence, installer package version is bumped to 0.1.138, and shadow parity hashes are refreshed.
- Next Step: Commit recovery fixes, push PR #979, run PR gate and GitHub checks, then merge or record blocker.
