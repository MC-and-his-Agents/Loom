...
- Blockers: None for merge; npm registry write/deprecate permission is unavailable in this environment (`npm whoami` -> E401 Unauthorized) and is recorded as owner-action evidence.
