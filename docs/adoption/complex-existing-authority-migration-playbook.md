...
The synthetic validation fixture lives at [complex-existing-authority-migration-fixtures.json](../evidence/fixtures/complex-existing-authority-migration-fixtures.json).
