...
- 执行侧的最小承接链路见 [../methodology/harness/execution-chain.md](../methodology/harness/execution-chain.md)
- `merge checkpoint` 的执行侧输入、结果与回退去向见 [../methodology/harness/merge-checkpoint.md](../methodology/harness/merge-checkpoint.md)

`admission checkpoint` 在 adoption 语义上表达“进入实现承诺前的正式判断”。
治理内核中的稳定命名与审查分工，见 [../methodology/governance/review-model.md](../methodology/governance/review-model.md)。
