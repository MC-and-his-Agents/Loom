...
EXPECTED_BOOTSTRAP_RUNTIME_SOURCES = {
    ...
    ".loom/bin/host_attestation.py": "skills/shared/scripts/host_attestation.py",
    ...
    ".loom/bin/github_admission.py": "skills/shared/scripts/github_admission.py",
    ".loom/bin/github_host.py": "skills/shared/scripts/github_host.py",
